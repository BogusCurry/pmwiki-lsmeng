...
$ImgfocusZoomToFitTime = 100;
$ImgfocusExceptionList = array('pic1.jpg','pic2.jpg');
...
$PageTimerExpDuration = 86400*365;
$PageTimerExpDurationSleep = 86400*365;
...
{
	$HTMLHeaderFmt['html5avctrl'] = "<script type='text/javascript' src='$PubDirUrl/html5avctrl/html5avctrl.js'></script>";
