 ...
 * security, the password is not stored in any form in the configuration file. Future
 ...
 * algorithm chosen is immune to known-plaintext attact, as are most modern encryption
 * algorithms; and most system breaches are not due to defects in encryption algorithms,
 * but due to security holes in storing password hashes. Please refer to the homepage of
 * PmWiki for basic guides and introduction. Please email me for detailed features and
 * support of each version if you are interested.
 *
